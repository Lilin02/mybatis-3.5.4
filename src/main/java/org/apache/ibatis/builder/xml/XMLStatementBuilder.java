...
public class XMLStatementBuilder extends BaseBuilder {
  ...
  public void parseStatementNode() {
    ...
    //获取sql语句的节点名（select|insert|update|delete）
    ...
    //用于解析sql，Configuration对象的构造方法设置了默认LanguageDriver为XMLLanguageDriver
    ...
    //保存sql语句以及相应的参数信息，BoundSql就是根据SqlSource的信息实例化的
    SqlSource sqlSource = langDriver.createSqlSource(configuration, context, parameterTypeClass);
    //执行sql的时候会根据该字段选择StatementHandler
    ...
    //通过MapperBuilderAssistant类型的builderAssistant实例化MappedStatement，并注册至configuration对象
